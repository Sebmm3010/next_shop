  ...
  const onFilesSelected = async ({ target }: ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      for (const file of target.files) {
        ...
        const { data } = await nextShopApi.post<{ msg: string }>(
          "/admin/upload",
          formData
        );
        setValue("images", [...getValues("images"), data.msg], {
          shouldValidate: true,
        });
      }
    } catch (error) {
          ...
          <Grid item xs={12} sm={6}>
            ...
            <Controller
              ...
              rules={{
                ...
                minLength: {
                  value: 8,
                  message: "La descripcion debe minimo tener 8 caracateres",
                },
              }}
              control={control}
              defaultValue=""
            ...
            <TextField
              ...
              {...register("price", {
                required: "Este campo es requerido",
                min: { value: 0, message: "Mínimo de valor es 0" },
              })}
              error={!!errors.price}
                ...
                <FormControlLabel
                  ...
                  control={
                    <Checkbox
                      ...
                      onChange={() => handleSizeChanges(size)}
                    />
                  }
                  label={size}
                />
